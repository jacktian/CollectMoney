...
import com.yzdsmart.Dingdingwen.views.city_picker.widget.wheel.OnWheelChangedListener;
import com.yzdsmart.Dingdingwen.views.city_picker.widget.wheel.WheelView;
import com.yzdsmart.Dingdingwen.views.city_picker.widget.wheel.adapters.ArrayWheelAdapter;
...
public class CityPicker implements CanShow, OnWheelChangedListener {
    ...
    private CityPicker(Builder builder) {
        ...
        popview = layoutInflater.inflate(R.layout.city_picker_popup, null);

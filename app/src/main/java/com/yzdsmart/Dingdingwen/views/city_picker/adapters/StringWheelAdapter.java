...
package com.yzdsmart.Dingdingwen.views.city_picker.adapters;

import android.content.Context;
import android.text.TextUtils;

import com.yzdsmart.Dingdingwen.views.time_picker.adapters.AbstractWheelTextAdapter;
...
public class StringWheelAdapter extends AbstractWheelTextAdapter {
     ...
     */
    public StringWheelAdapter(Context context, int minValue, int maxValue, String format) {
     ...
     */
    public StringWheelAdapter(Context context, int minValue, int maxValue, String format, String unit) {
        super(context);

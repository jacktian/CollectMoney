...
package com.yzdsmart.Dingdingwen.views.city_picker.widget.wheel;
...
import com.yzdsmart.Dingdingwen.views.city_picker.widget.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    // Wheel drawables
    private int wheelBackground = R.drawable.city_picker_wheel_bg;

    private int wheelForeground = R.drawable.city_picker_wheel_val;
...
//        paint.setColor(getResources().getColor(R.color.city_picker_province_line_border));
//        // 设置线宽

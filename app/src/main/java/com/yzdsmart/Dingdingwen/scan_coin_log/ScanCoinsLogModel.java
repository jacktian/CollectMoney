...
public class ScanCoinsLogModel {
    ...
    void getCoinsLog(String action, String submitCode, String custCode, Integer pageIndex, Integer pageSize, Integer lastsequence, String authorization, final RequestListener listener) {
        ...
        RequestAdapter.getDDWRequestService().getCoinsLog(action, submitCode, custCode, pageIndex, pageSize, lastsequence, authorization)

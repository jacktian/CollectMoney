...
public class QRScannerModel {
    ...
    void getCoins(String action, String submitCode, String custCode, String bazaCode, String coor, String ip, String authorization, final RequestListener listener) {
        ...
        RequestAdapter.getDDWRequestService().getGoldCoins(action, submitCode, custCode, bazaCode, coor, ip, authorization)

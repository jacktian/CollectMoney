...
public class ImageCropModel {
    ...
    void uploadPortrait(String action, String fileName, String fileData, String tcAccount, final RequestListener listener) {
        ...
        RequestAdapter.getRequestService().uploadPortrait(action, fileName, fileData, tcAccount)

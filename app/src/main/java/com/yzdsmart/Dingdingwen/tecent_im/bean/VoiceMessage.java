...
public class VoiceMessage extends Message {
    ...
    public void showMessage(ChatAdapter.ViewHolder viewHolder, Context context) {
        LinearLayout linearLayout = new LinearLayout(App.getAppInstance());
        linearLayout.setOrientation(LinearLayout.HORIZONTAL);
        linearLayout.setGravity(Gravity.CENTER);
        ImageView voiceIcon = new ImageView(App.getAppInstance());
        voiceIcon.setBackgroundResource(message.isSelf() ? R.drawable.tecent_right_voice : R.drawable.tecent_left_voice);
    ...
    public String getSummary() {
        return App.getAppInstance().getString(R.string.summary_voice);
    }

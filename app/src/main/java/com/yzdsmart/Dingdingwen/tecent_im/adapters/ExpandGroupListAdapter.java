...
public class ExpandGroupListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.tecent_item_group, null);
        ...
        if (isExpanded) {
            groupHolder.tag.setBackgroundResource(R.mipmap.tecent_open);
        } else {
            groupHolder.tag.setBackgroundResource(R.mipmap.tecent_close);
        }
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.tecent_item_child_member, null);
        ...
        itemHolder.tag.setImageResource(data.isSelected() ? R.mipmap.tecent_selected : R.mipmap.tecent_unselected);
        return convertView;
    }

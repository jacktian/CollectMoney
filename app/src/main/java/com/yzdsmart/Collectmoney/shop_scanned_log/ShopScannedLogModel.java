...
public class ShopScannedLogModel {
    ...
    void getScannedLog(String action, String submitCode, String bazaCode, Integer pageIndex, Integer pageSize, final RequestListener listener) {
        ...
        RequestAdapter.getRequestService().getScannedLog(action, submitCode, bazaCode, pageIndex, pageSize)

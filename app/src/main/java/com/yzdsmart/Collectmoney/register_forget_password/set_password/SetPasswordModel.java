...
public class SetPasswordModel {
    ...
    void setPassword(String userName, String password, String regCode, final RequestListener listener) {
        ...
        RequestAdapter.getRequestService().setPassword(userName, password, regCode)

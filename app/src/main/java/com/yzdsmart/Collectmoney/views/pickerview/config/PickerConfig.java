package com.yzdsmart.Collectmoney.views.pickerview.config;
...
public class PickerConfig {
    ...
    public int mCancelTVColor = DefaultConfig.CANCEL_COLOR;
    public int mSureTVColor = DefaultConfig.SURE_COLOR;
    public int mTitleTVColor = DefaultConfig.TITLE_COLOR;

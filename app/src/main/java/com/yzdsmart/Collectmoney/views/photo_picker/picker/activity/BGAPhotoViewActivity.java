package com.yzdsmart.Collectmoney.views.photo_picker.picker.activity;
 ...
 * 描述:图片选择预览界面
 */
public class BGAPhotoViewActivity extends BGAPPToolbarActivity implements PhotoViewAttacher.OnViewTapListener {
    ...
    public static Intent newIntent(Context context, int maxChooseCount, ArrayList<String> selectedImages, ArrayList<String> previewImages, int currentPosition, boolean isFromTakePhoto) {
        Intent intent = new Intent(context, BGAPhotoViewActivity.class);

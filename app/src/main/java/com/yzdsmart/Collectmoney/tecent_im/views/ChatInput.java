...
public class ChatInput extends RelativeLayout implements TextWatcher, View.OnClickListener {
    ...
    public ChatInput(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.tecent_chat_input, this);
        initView();
    }
    ...
    private void updateVoiceView() {
        if (isHoldVoiceBtn) {
            ...
            voicePanel.setBackgroundDrawable(getResources().getDrawable(R.drawable.tecent_btn_voice_pressed));
            chatView.startSendVoice();
        } else {
            voicePanel.setText(getResources().getString(R.string.chat_press_talk));
            voicePanel.setBackgroundDrawable(getResources().getDrawable(R.drawable.tecent_btn_voice_normal));
